...
def insert_meal_plan(meal_plan):
    ...
    meal_plan['model'] = 'gemini-1.5-pro'
...
# Call this function to insert meal plans from files
insert_meal_plans_from_files()

# main method
def main():
    # Call the function to insert meal plans from files
    insert_meal_plans_from_files()
    
    # Call the function to retrieve meal plans from the database
    get_meal_plan()
